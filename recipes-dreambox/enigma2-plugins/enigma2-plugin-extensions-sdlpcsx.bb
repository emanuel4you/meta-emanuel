...
SUMMARY = "Sony Playstation Emulator for dreambox"
...
PV = "0.2"
PR = "r1"
PN = "enigma2-plugin-extensions-sdlpcsx"
...
FILES_${PN} += "/usr/lib/enigma2/python/Plugins/Extensions/SDLPcsx"

inherit autotools-brokensep

pkg_postrm_${PN}() {
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/SDLPcsx
}