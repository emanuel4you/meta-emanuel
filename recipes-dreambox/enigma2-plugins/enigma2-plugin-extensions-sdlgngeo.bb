...
SUMMARY = "NeoGeo Emulator for dreambox"
...
PV = "0.1"
PR = "r0"
PN = "enigma2-plugin-extensions-sdlgngeo"
...
FILES_${PN} += "/usr/lib/enigma2/python/Plugins/Extensions/SDLGnGeo"

inherit autotools-brokensep

pkg_postrm_${PN}() {
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/SDLGnGeo
}